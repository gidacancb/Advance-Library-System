...
public class BookRental extends JFrame {
	...
	public BookRental() {
		...
		panel.setBounds(0, 83, 744, 588);
		contentPane.add(panel);
		panel.setLayout(null);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(BookRental.class.getResource("/image/tsip.png")));
		...
		lblNewLabel_7.setIcon(new ImageIcon(BookRental.class.getResource("/image/got.png")));
		...
		lblNewLabel_12.setIcon(new ImageIcon(BookRental.class.getResource("/image/cc.png")));
		...
		lblNewLabel_20.setBounds(223, 491, 171, 21);
		...
		lblNewLabel.setIcon(new ImageIcon(BookRental.class.getResource("/image/lib.png")));
		...
		button.setBounds(331, 518, 103, 27);
		panel.add(button);
		...
		txtChoice.setBounds(394, 493, 90, 20);
		panel.add(txtChoice);
